...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ children, variant = "primary", size = "md", className = "", disabled = false, ...props }, ref) => {
    ...
    const variantClasses: Record<ButtonVariant, string> = {
      primary: "bg-blue-500 text-white hover:bg-blue-600 focus:outline-sky-600 focus:outline-dashed",
      secondary: "bg-neutral-300 text-neutral-800 hover:bg-neutral-400/80 focus:outline-pink-400 focus:outline-dashed",
      destructive: "bg-red-400 text-white hover:text-white hover:bg-red-700 focus:outline-red-700 focus:outline-dashed",
    };
